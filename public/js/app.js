            ...
            success: function(data) {
                ...
                var calendar = $('#calendar').fullCalendar({
                    ...
                    select: function select(start, end, allDay) {
                        var title = confirm('Tạo một đơn hàng trong ngày ' + new Date(start).toLocaleDateString());
                        console.log(title);
                        if (title) {
                            window.location.replace("/DH/CREATE?date=" + new Date(start));
